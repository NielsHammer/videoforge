        ...
        {items.slice(0, 8).map((item, i) => {
          ...
          return (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 16, opacity: itemOp }}>
              <div style={{ width: 220, textAlign: "right", fontSize: 18, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontWeight: 700, color: "#ffffff", fontFamily: "'Arial Black', Arial, sans-serif", flexShrink: 0 }}>
                {item.label || ""}
              </div>
