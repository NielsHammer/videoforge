...
async function recoverStuckOrders() {
  try {
    ...
    // Auto-requeue removed — failed orders stay failed until manually requeued by admin.
    // Automatic requeuing caused all historical failed orders to regenerate unexpectedly.
  } catch (err) {
